...
const AnimatedHamburgerButton = ({ action }: any) => {
...
export default () => {
  ...
  const navigation = [
    ...
    { title: "Our Projects", path: "javascript:void(0)", isDrapdown: false },
  ];
  ...
  return (
    <>
      <nav
        // style={{ zIndex: 200 }}
        className={`relative z-20 bg-gray-900 w-full md:static md:text-sm md:border-none justify-between fixe absolut ${
          state ? "shadow-lg rounded-b-xl md:shadow-none fixe" : ""
        }`}
      >
        <div
          style={{ zIndex: 200 }}
          className="items-center gap-x-14 px-4 w-full mx-auto md:flex md:px-8 fixed bg-gray-900 justify-between"
        >
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <a
              href="javascript:void(0)"
              className="flex align-middle items-center justify-center gap-3"
            >
              <Flex gap={6}>
            ...
            <ul className="items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
              {navigation.map((item, idx) => {
                return (
                  <li key={idx}>
                    <a
                      href={item.path}
                      className="block text-gray-200 hover:text-blue-700"
                    >
                      {item.title}
                    </a>
              ...
              <div className="flex-1 items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0">
                <li>
                  <a
                    href="javascript:void(0)"
                    className="block py-3 text-center text-gray-200 hover:text-blue-600 border rounded-lg md:border-none"
                  >
                    Log in
                  </a>
                </li>
